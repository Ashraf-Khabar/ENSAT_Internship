        ...
        <div className="flex">
            <div className="flex w-2/5 md:w-1/4 h-screen bg-white">
                <div className="mx-auto py-10">
                    <ul>
                        <li
                            className="flex space-x-2 mt-10 cursor-pointer text-[#EC5252] active:text-[#EC5252] duration-150"
                        >
                            <svg
                            ...
                            <Link className="font-semibold" to="/dashboard">Home</Link>
                        </li>
            ...
            <div className=" min-h-screen w-full">
                ...
                <div
                    className="overflow-y: scroll items-center justify-center ml-10 mr-10 mt-5  bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <ul className="flex flex-col mb-2 divide-y divide">
                        {offersList.map((offer, key) => (
                            ...
                            <Link className="flex flex-row   hover:bg-indigo-200"
                                  to={{pathname: "/dashboard/offer/" + offer.id}}>
